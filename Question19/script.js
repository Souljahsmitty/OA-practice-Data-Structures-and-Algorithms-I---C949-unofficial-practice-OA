    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! The worst-case occurs when the pivot always selects the smallest or largest element, leading to an unbalanced partition.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: The worst-case occurs when the pivot always selects the smallest or largest element, leading to an unbalanced partition.";
				feedback.className = "wrong";
			}
        });
    } else {
