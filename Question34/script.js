    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! An LRU cache efficiently maintains recently used elements using a hash table for fast lookups and a doubly linked list for tracking order.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **B. An LRU cache efficiently maintains recently used elements using a hash table for fast lookups and a doubly linked list for tracking order.";
				feedback.className = "wrong";
			}
        });
    } else {
