    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! Radix Sort sorts numbers digit by digit and does not rely on comparisons.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is **C. Radix Sort sorts numbers digit by digit and does not rely on comparisons.";
                feedback.className = "wrong";
            }
        });
    } else {
