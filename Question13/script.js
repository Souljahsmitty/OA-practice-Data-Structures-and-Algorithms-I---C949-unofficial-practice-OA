    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! A queue follows the FIFO principle, meaning elements are inserted at one end (rear) and removed from the other end (front).";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: A queue follows the FIFO principle, meaning elements are inserted at one end (rear) and removed from the other end (front).";
				feedback.className = "wrong";
			}
        });
    } else {
