    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Stable sorting algorithms keep elements with equal values in their original relative order.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Stable sorting algorithms keep elements with equal values in their original relative order.";
				feedback.className = "wrong";
			}
        });
    } else {
