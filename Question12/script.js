    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "D") {
                ...
                feedback.textContent = "✘ Incorrect. The correct answer is B.Memory sweeping is part of garbage collection that reclaims memory no longer in use by identifying objects no longer accessible.";
                feedback.className = "wrong";
            }
        });
    } else {
