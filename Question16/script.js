    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A sentinel node is used to avoid special cases when inserting or deleting nodes at the head or tail.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: A sentinel node is used to avoid special cases when inserting or deleting nodes at the head or tail.";
				feedback.className = "wrong";
			}
        });
    } else {
