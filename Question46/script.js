    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Array indexing provides direct access to elements in O(1) time.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is **B. Array indexing provides direct access to elements in O(1) time.";
                feedback.className = "wrong";
            }
        });
    } else {
