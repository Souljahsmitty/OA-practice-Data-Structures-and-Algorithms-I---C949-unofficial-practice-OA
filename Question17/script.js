    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Insertion Sort is highly efficient for nearly sorted arrays with a best-case time complexity of O(n).";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Insertion Sort is highly efficient for nearly sorted arrays with a best-case time complexity of O(n).";
				feedback.className = "wrong";
			}
        });
    } else {
