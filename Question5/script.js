    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! A stack is a collection of elements that follows the LIFO principle, where the last element added is the first one to be removed.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: A stack is a collection of elements that follows the LIFO principle, where the last element added is the first one to be removed.";
				feedback.className = "wrong";
			}
