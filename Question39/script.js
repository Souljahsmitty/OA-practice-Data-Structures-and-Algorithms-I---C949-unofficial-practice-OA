    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Graphs are represented using adjacency lists (space-efficient) or adjacency matrices (faster lookups).";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Graphs are represented using adjacency lists (space-efficient) or adjacency matrices (faster lookups).";
				feedback.className = "wrong";
			}
        });
    } else {
