    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! In a max heap, the root node contains the largest element.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is **B. In a max heap, the root node contains the largest element.";
                feedback.className = "wrong";
            }
        });
    } else {
