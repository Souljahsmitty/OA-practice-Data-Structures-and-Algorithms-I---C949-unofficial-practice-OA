    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! In a balanced BST, each comparison allows the operations to skip about half of the tree, leading to logarithmic time complexity.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: In a balanced BST, each comparison allows the operations to skip about half of the tree, leading to logarithmic time complexity.";
                feedback.className = "wrong";
            }
