    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Pre-order traversal processes the root node before its child nodes, following the order: root, left subtree, right subtree.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B. Pre-order traversal processes the root node before its child nodes, following the order: root, left subtree, right subtree.";
                feedback.className = "wrong";
            }
        });
    } else {
