    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! In static arrays with fixed size, attempting to add an element beyond its capacity results in an overflow error.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect.The correct answer is C. In static arrays with fixed size, attempting to add an element beyond its capacity results in an overflow error.";
                feedback.className = "wrong";
            }
        });
    } else {
