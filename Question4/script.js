    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! Merge Sort has an average-case time complexity of O(n log n), which is more efficient than the quadratic time complexities of Bubble Sort, Insertion Sort, and Selection Sort.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: Merge Sort has an average-case time complexity of O(n log n), which is more efficient than the quadratic time complexities of Bubble Sort, Insertion Sort, and Selection Sort.";
				feedback.className = "wrong";
			}
