    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! Function calls use a stack (call stack) to store return addresses and local variables.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is A: Function calls use a stack (call stack) to store return addresses and local variables.";
                feedback.className = "wrong";
            }
        });
    } else {
