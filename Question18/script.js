    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A stack follows the Last-In-First-Out (LIFO) principle, making it ideal for tracking the most recent operations for undo functionality.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A. A stack follows the Last-In-First-Out (LIFO) principle, making it ideal for tracking the most recent operations for undo functionality.";
				feedback.className = "wrong";
			}
        });
    } else {
