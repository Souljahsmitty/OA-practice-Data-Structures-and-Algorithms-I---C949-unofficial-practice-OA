    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Queues follow FIFO, where elements are inserted at the rear and removed from the front.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. B.Queues follow FIFO, where elements are inserted at the rear and removed from the front.";
                feedback.className = "wrong";
            }
        });
    } else {
