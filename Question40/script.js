    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Dijkstra’s algorithm efficiently finds the shortest path in graphs with positive edge weights.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Dijkstra’s algorithm efficiently finds the shortest path in graphs with positive edge weights.";
				feedback.className = "wrong";
			}
        });
    } else {
