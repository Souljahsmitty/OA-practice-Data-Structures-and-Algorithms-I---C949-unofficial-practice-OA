    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Linked lists do not have a fixed size, meaning they can dynamically grow or shrink as elements are added or removed. ";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Linked lists do not have a fixed size, meaning they can dynamically grow or shrink as elements are added or removed. ";
				feedback.className = "wrong";
			}
        });
    } else {
