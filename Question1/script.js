    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! A deque (double-ended queue) allows insertion and deletion at both ends.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is C. A deque (double-ended queue) allows insertion and deletion at both ends.";
                feedback.className = "wrong";
            }
