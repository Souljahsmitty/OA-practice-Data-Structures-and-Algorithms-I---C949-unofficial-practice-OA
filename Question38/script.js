    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Hash tables provide average-case O(1) lookup time, making them efficient for searching.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A. Hash tables provide average-case O(1) lookup time, making them efficient for searching.";
				feedback.className = "wrong";
			}
        });
    } else {
