    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! Dynamic memory allocation allows programs to request memory during execution rather than at compile time.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. A.Dynamic memory allocation allows programs to request memory during execution rather than at compile time.";
                feedback.className = "wrong";
            }
        });
    } else {
