    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Depth-first search (DFS) uses in-order, pre-order, or post-order traversal methods.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **B. Depth-first search (DFS) uses in-order, pre-order, or post-order traversal methods.";
				feedback.className = "wrong";
			}
        });
    } else {
