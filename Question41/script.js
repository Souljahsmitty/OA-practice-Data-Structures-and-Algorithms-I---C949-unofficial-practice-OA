    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Arrays are a concrete data structure, while ADTs describe behavior rather than implementation.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Arrays are a concrete data structure, while ADTs describe behavior rather than implementation.";
				feedback.className = "wrong";
			}
        });
    } else {
